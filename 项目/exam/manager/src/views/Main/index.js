...
import WaitClass from '../Examination/waitClass/waitClass'
import Classmate from '../Examination/Classmate/classmate'
import Dateils from '../Examination/Classdetail/details'
    ...
    <Layout>
      ...
      <Content>
        <Switch>
          ...
          <Route path="/Examination/waitClass" component={WaitClass}></Route>
          <Route path="/Classmate/classmate" component={Classmate}></Route>
          <Route path="/Classdetail/details" component={Dateils}></Route>
        </Switch>
      </Content>
    </Layout>
  </Layout>
